...
עדכון אחרון: commit `30bf343`. זהו snapshot בלבד — מדריך ההפעלה המלא נמצא ב-`docs/ADMIN_SETUP.md`.

## פרטי גרסה
- **Branch:** `gemini/recovery-sync-20260503-073319`
- **Latest commit:** `30bf343 chore(release): document admin setup and harden config checks`
