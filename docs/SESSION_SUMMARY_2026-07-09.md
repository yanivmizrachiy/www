...
### ג. luz-teddy/ — הוסרה
אפליקציה נפרדת (לוח פעילות בית ספרי, ללא קשר למוצרי Moodle) **נמחקה מהריפו לפי הוראת יניב (2026-07-09)**, כולל שתי ה-CI workflows הייעודיות שלה. אפס references נשארו בקוד. ניתנת לשחזור מהיסטוריית git אם יידרש ריפו נפרד בעתיד.
