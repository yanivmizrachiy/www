...
- **קישור ישיר בתוך הכלי (חובה):** המורה רואה קישור **"מצגת הדרכה"** תמיד — גם בסייד-בר (קבוצת "תמיכה") וגם בעמוד הבית — הנפתח ל-`/guide` **בלשונית חדשה, לצפייה/שימוש בלבד ולא להורדה.**
