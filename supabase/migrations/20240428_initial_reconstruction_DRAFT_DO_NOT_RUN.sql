-- DRAFT ONLY. DO NOT RUN ON PRODUCTION SUPABASE.
-- This migration was reconstructed from AI Studio output and must be reviewed before use.
-- It may conflict with existing database schema.
-- It must not contain real secret values.
-- No SQL from this file has been run as part of this PR.
