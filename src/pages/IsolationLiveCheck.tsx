    ...
    >
      <div className="space-y-5" dir="rtl">
        ...
        <p className="text-xs leading-5 text-muted-foreground">
          מוצגים מזהי התקנה/קורס וספירות בלבד — ללא שמות, ללא כתובות דוא״ל, ללא מזהי משתמש, ללא אישורי גישה וללא סודות.
          השחרור הרחב למורים נשאר סגור עד שהבדיקה החיה תושלם.
        </p>
      </div>
    </SafePage>
  );
