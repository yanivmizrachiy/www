...
const TOPICS: Topic[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 'no-data',
        title: 'פתחתם את הכלי אבל אין נתונים?',
        short: 'הכלי מציג נתונים רק אחרי שמייבאים דוח מ-Moodle. עד אז המסך ריק — וזה תקין.',
        steps: [
          'פתחו "ייבוא חכם" בכלי',
          'לחצו על הדוח שאתם צריכים — הוא נפתח בקורס שלכם ב-Moodle',
          'הורידו שם את הקובץ, וגררו אותו חזרה לאזור הייבוא',
        ],
      },
      {
        id: 'tool-not-found',
        title: 'לא מוצאים את הכלי במרחב?',
        short: 'ב-Moodle של משרד החינוך הכלי לא מופיע בבורר הפעילויות הרגיל — מוסיפים אותו דרך תפריט הקורס.',
        steps: [
          'בתפריט הקורס לחצו "אפשרויות נוספות"',
          'בחרו "כלי או שירות LTI חיצוני" ואז "Add tool"',
          'מלאו את הפרטים לפי דף ההתקנה של הכלי',
        ],
      },
    ],
  },
