    ...
    questions: [
      ...
      },
      {
        ...
        steps: [
          ...
          'ממלאים את הפרטים: שם בית הספר, מקצוע, שכבת גיל וכיתה',
          'לוחצים "הבא" וממשיכים לפי השלבים עד "אישור וסיום התהליך"',
        ],
        tip: 'אם לא נמצאו קבוצות לימוד — בוחרים "ללא קבוצת לימוד" וממלאים את הפרטים ידנית. המרחב החדש יופיע ב"מרחבי־הלימוד שלי".',
        link: {
