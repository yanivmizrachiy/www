...
const TOPICS: Topic[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        steps: [
          'לוחצים על הקישור לאשף, או על "פתיחת מרחב כיתתי" בעמוד "מרחבי־הלימוד שלי"',
          'בשלב 1 בוחרים "עם קבוצת לימוד" או "ללא קבוצת לימוד"',
          'ממלאים 4 תפריטים: שם בית הספר, מקצוע, שכבת גיל (ז׳–יב׳) וכיתה (1–30)',
          'לוחצים "הבא" וממשיכים לפי השלבים עד "אישור וסיום התהליך"',
        ],
...
const QUESTION_SHOTS: Record<string, Shot[]> = {
  ...
  'space/open-new-space': [
    ...
    {
      src: '21-wizard-step1-form.jpg',
      caption: 'ממלאים את הפרטים: שם בית הספר, מקצוע, שכבת גיל וכיתה — ולוחצים "הבא"',
    },
  ],
};
