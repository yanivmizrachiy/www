  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        short: 'ברוב המרחבים אצלנו זה כבר פתוח מראש: שולחים לתלמיד את קישור המרחב. התלמיד פותח את הקישור, מגיע למסך "שיוך עצמי (תלמיד)", ולוחץ "רשום אותי" — ורק אחרי הלחיצה הזו הוא הופך לחלק מהמרחב. אם תלמיד לא מצליח להיכנס — בודקים בעמוד "משתתפים" ששיטת השיוך העצמי עדיין פעילה.',
        steps: [
  ...
  'participants/self-enrol': [
    {
      ...
      caption: 'מה שהתלמיד רואה אחרי פתיחת הקישור — לוחץ "רשום אותי" כדי להצטרף למרחב',
      custom: 'שם המשתמש בסרגל העליון הוא דוגמה (שם בדוי)',
    },
    {
