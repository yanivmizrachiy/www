            ...
            {!data?.log_events_count && (
              <div className="rounded-lg border p-3 flex gap-3 text-sm">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mt-1 text-xs">לא הועלה דוח יומני פעילות. ללא יומנים אין ראיות פעילות; זמן תרגול רשמי דורש שדה משך מאומת ממודל.</p>
                  <Link to="/smart-import" className="text-primary hover:underline font-bold text-[10px] mt-2 block">עבור לייבוא יומני פעילות</Link>
                </div>
              </div>
            )}
            ...
            {!data?.tasks_count && (
              <div className="rounded-lg border p-3 flex gap-3 text-sm">
                ...
                <div>
                  ...
                  <Link to="/smart-import" className="text-primary hover:underline font-bold text-[10px] mt-2 block">עבור לייבוא השלמת פעילות</Link>
                </div>
              </div>
            )}
