...
(async () => {
  ...
  if (asset) {
    ...
    markerFound = js.body.includes("MTH_WIDE_GRADEBOOK_IMPORT_UI_V1");
  }

  console.log(JSON.stringify({
    ok: true,
    mode: "wide-gradebook-import-ui-live-check",
    version: "MTH_WIDE_GRADEBOOK_IMPORT_UI_CHECK_V1",
    marker_found: markerFound,
    expected_marker: "MTH_WIDE_GRADEBOOK_IMPORT_UI_V1",
